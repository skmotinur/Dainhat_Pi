...
map.getView().fit([9808464.029623, 2703339.059324, 9820860.649711, 2709689.786828], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PI INDEX</h2>';
        return titleElement;
    })(),
